...
function drawLabels(ctx, ctxWidth, ctxHeight, r1, r2, border, scale)
{
	...
	//drawLabel("0.1", (border-35), (ctxHeight-border-scale*0.1), ctx);
	//drawLabel("0.2", (border-35), (ctxHeight-border-scale*0.2), ctx);
	drawLabel("0.25", (border-35), (ctxHeight-border-scale*0.25), ctx);
	//drawLabel("0.3", (border-35), (ctxHeight-border-scale*0.3), ctx);
	//drawLabel("0.4", (border-35), (ctxHeight-border-scale*0.4), ctx);
	drawLabel("0.5", (border-35), (ctxHeight-border-scale*0.5), ctx);
	//drawLabel("0.6", (border-35), (ctxHeight-border-scale*0.6), ctx);
	//drawLabel("0.7", (border-35), (ctxHeight-border-scale*0.7), ctx);
	drawLabel("0.75", (border-35), (ctxHeight-border-scale*0.75), ctx);
	//drawLabel("0.8", (border-35), (ctxHeight-border-scale*0.8), ctx);
	//drawLabel("0.9", (border-35), (ctxHeight-border-scale*0.9), ctx);
...
function main()
{
	...
	if (canvas.getContext)
	{
		...
		if (r1 < r2)
		{
			...
			drawLabels(ctx, ctxWidth, ctxHeight, r1, r2, border, scale);
			runSystem(ctx, state, r1, r2, numberOfPoints, slices, dx, radius, ctxHeight, border, scale);
        }
		else
		{
